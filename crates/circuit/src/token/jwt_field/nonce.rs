...
pub fn jwt_nonce_hex_to_field<F: PrimeField>(
    ...
    ark_r1cs_helpers::comparison::enforce_less_than(&lower_exclusive_bits, &idx_bits)?;
    ark_r1cs_helpers::comparison::enforce_less_than(&idx_bits, &upper_exclusive_bits)?;
