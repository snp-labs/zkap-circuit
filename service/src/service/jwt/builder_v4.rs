use circuit::baerae::constants::{CLAIMS, MAX_JWT_B64_LEN, MAX_PAYLOAD_B64_LEN};
use gadget::{
...
impl TokenBuilderV3 {
    ...
    pub fn build(&self, pk_modulus_b64: &str) -> Result<JwtCircuitWitness, TokenError> {
        // 1. SHA-256 State 및 Padding 계산
        let (state, nblocks, sha_pad_payload_b64, index_bits, pay_offset_b64, pay_len_b64) =
            self.compute_sha_and_base64_witness()?;
